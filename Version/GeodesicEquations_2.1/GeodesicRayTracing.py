...
# ==============================================================================================
    ...
    def local_to_global_4momentum(self, vector_position, vect_napr_cont):
        """
...
@profile
def OpenCL(initial_states, lambda_0, lambda_end, h, r_s, global_size, max_points=1000, save_step=10, dtype=np.float64):
    ...
    kernel_path = os.path.join(script_dir, "OpenClKernelSchwarzschild.cl")
...
if __name__ == "__main__":
    ...
    r_0 = 1.0           # Горловина кротовой норы
    ...
    camera = Camera(width=W, height=H, focus=3, metric=metric_schwarzschild)
    ...
    # Визуализация
    plot_trajectories(trajectories, point_counts, r_s, W, H, step_ray=33,
