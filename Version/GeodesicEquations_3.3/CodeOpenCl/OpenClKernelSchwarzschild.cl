...
// Функция для безопасного вычисления sin(theta) с защитой от сингулярностей
...
// Функция для проверки и коррекции сингулярных точек
...
__kernel void runge_kutta4_trajectories(
    ...
    for (int i = 0; i < iterations; i++) {
        ...
        // Обрабатываем сингулярные точки
    ...
    // Сохраняем финальную точку, если есть место и мы не вышли за горизонт
