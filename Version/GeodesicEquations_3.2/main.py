...
if __name__ == "__main__":
    ...
    camera_pos = Vector4(t=0, x=90, y=np.pi/2, z=0, vtype=VectorType.COORDINATES, dtype=np.float64)
    ...
    trajectories, point_counts = tracer.ray_tracing(
        MetricType.SCHWARZSCHILD,
        initial_states_cov,
    ...
    np.savetxt('GeodesicEquations\\full_array.txt', trajectories, delimiter='\t', encoding='utf-8', fmt='%.3f')
