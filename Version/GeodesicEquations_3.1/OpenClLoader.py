...
class OpenClKernelLoader:
    ...
    def compute_trajectories(self, 
        ...
        # Определяем общее количество лучей
        total_rays = global_size
        ...
        batch_size = self._calculate_batch_size(total_rays, max_points, dtype)
    ...
    def _calculate_batch_size(self, total_rays: int, max_points: int, dtype: type) -> int:
