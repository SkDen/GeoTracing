...
if __name__ == "__main__":
    ...
    L = (M-0.001)**2            # Момент вращения ЧД Керра
    ...
    current_metric = metric_parameter_wormhole
    ...
    camera_pos = Vector4(t=0, x=5, y=np.pi/2, z=np.pi/2, vtype=VectorType.COORDINATES, dtype=np.float64)
    ...
    point, flag = ray_tracer.ray_tracing(MetricType.PARAMETERIZED_WORMHOLE,
                                        initial_states_cov,
