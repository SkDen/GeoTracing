...
GeoTracing распространяется под лицензией BSD 3-Clause

**Вы можете:**
Вы можете:
- Использовать в любых целях, включая коммерческие
- Модифицировать, адаптировать и создавать производные работы
- Распространять оригинал и модификации в исходном или двоичном виде

**При условиях:**
- Сохранение уведомления об авторских правах
- Воспроизведение условий – при распространении в двоичной форме нужно включить тот же текст лицензии в документацию или сопроводительные материалы
- Запрет на использование имени автора – нельзя использовать имя автора или название проекта для продвижения продуктов без письменного разрешения
